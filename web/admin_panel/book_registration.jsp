                                    ...
                                    <div class="main">
                                        ...
                                        <main>
                                            ...
                                            <div id="contentOfAjax"> 
                                                ...
                                                <form action="../BookSRegistration" method="POST" enctype="multipart/form-data">
                                                    <table border="1">
                                                        <tr>
                                                            <td colspan="2" width="50%">File Name</td>
                                                            <td colspan="2" width="50%"><input type="text" name="name" placeholder="Java How to Program" autofocus required></td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="2" width="50%">Subject</td>
                                                            <td colspan="2" width="50%"><input type="text" name="author" placeholder="Paul Deitel" required></td>
                                                        </tr>
                                                        <tr>
